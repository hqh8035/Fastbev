...
def main():
    ...
    parser.add_argument('--height', type=int, default=1088, help='input height')            # raw input
    ...
    parser.add_argument("--camera_intrinsic", type=float, nargs=9, default=[                # set default value here, adapt to your camera intrinsics, here corresponds to 1088*1280
    ...
    try:
        ...
        onnx_dir = f"./outputs/export/export_{datetime_str}"
        os.makedirs(onnx_dir, exist_ok=True)
        
        print(f"ONNX model will be saved to: {onnx_dir}")
        ...
        export_onnx(model, images_tensor, onnx_path)
