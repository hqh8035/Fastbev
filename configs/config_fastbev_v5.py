...
_C.DATASET.TRAIN.waymo.with_seg_grass_label = True
...
_C.DATASET.TRAIN.waymo.annotations_file = 'data/mix_train_image_list.txt'  # 'data/mix_train_image_list.txt'
...
_C.DATASET.VAL.waymo.with_seg_lane_line_label = True
_C.DATASET.VAL.waymo.with_det3d_label = True
_C.DATASET.VAL.waymo.with_seg_grass_label = True
_C.DATASET.VAL.waymo.generation_gt = 'standard' 
_C.DATASET.VAL.waymo.annotations_file = 'data/mix_train_image_list.txt'
