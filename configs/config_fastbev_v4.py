...
_C.MODEL.PRETRAINED_PATH = "all_with_seg_checkpoints/fastbev_2025-09-01_18-38-49/checkpoint_step_80000.pth"  # 预训练模型路径
...
_C.MODEL.FASTBEV.DET_OUT_CHANNELS = 27                        # 检测输出的channels数, center + obj_height + offset + lwh + yaw = 1 + 1 + 2 + 3 + 2, 3个类别 
...
_C.DATASET.TRAIN.waymo.with_det_label = True
...
_C.DATASET.TRAIN.waymo.annotations_file = 'data/train_label_list.txt'
...
_C.DATASET.VAL.waymo.with_det_label = True
_C.DATASET.VAL.waymo.generation_gt = 'standard' 
_C.DATASET.VAL.waymo.annotations_file = 'data/train_label_list.txt'
...
# 路径配置
_C.PATH = CN()
_C.PATH.CHECKPOINT_DIR = './all_with_modify_loss_checkpoints/fastbev'
